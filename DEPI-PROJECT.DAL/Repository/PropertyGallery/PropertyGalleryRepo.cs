...
namespace DEPI_PROJECT.DAL.Repository.PropertyGallery
{
    public class PropertyGalleryRepo : IPropertyGalleryRepo
    {
        ...
        public void Add(DataModels.PropertyGallery gallery)
        {
            if (gallery == null)
        ...
        public IEnumerable<DataModels.PropertyGallery> GetAll()
        {
        ...
        public IEnumerable<DataModels.PropertyGallery> GetByPropertyId(Guid propertyId)
        {
            return _context.PropertyGalleries
                           .AsNoTracking()
        ...
        public void AddRange(IEnumerable<DataModels.PropertyGallery> galleries)
        {
            _context.PropertyGalleries.AddRange(galleries);
            var affected = _context.SaveChanges();
            Console.WriteLine($"Rows affected: {affected}");
        }
        public DataModels.PropertyGallery? GetById(Guid id)
        {
            return _context.PropertyGalleries
                           //.AsNoTracking()
